...
import right from "../../images/Frame 13.png";
    ...
    <>
      ...
      <main className=" min-h-screen --font-clash  justify-between lg:pt-28 pt-24 pb-10   ">
        <section className="max-w-[1200px] mx-auto p-6">
          <div className="w-full ">
            ...
            <h2 className=" text-4xl md:text-5xl  max-w-[700px]  font-semibold mb-4  text-blue-950">
              Advanced Transparency controls for your Donors
            </h2>
            <p className="text-gray-600 font-light mb-2 max-w-[1200px]  ">
              Protect your reputation during the fundraise process by leveraging
              our transparency flows in your projects. Whether you&apos;re
              fundraising for a friend in need, a private or commercial project,
              or a civil undertaking, you can provide your donors with direct
              visibility and control on their donations, enabling them to
              interact, review and control the flow of their donations through
              secure APIs without needing your direct input. And you can
              customise the extent of control and access you give to donors. No
              longer would you have to deal with suspicions and tarnished
              reputation for attempting to help through a public fundraise.
            </p>
            <div className="flex items-center pt-2 md:mb-10 gap-3 mt-3">
              <a
                href="https://project.algoralign.com/signup"
              ...
              <a
                ...
                className="mb-10  hover:opacity-75 text-blue-600 border border-blue-600 px-4 py-2 rounded"
              >
                Donate
              </a>
            </div>
        ...
        <div className="px-5 w-full">
          <section className="md:px-10 px-5 p-5 max-w-[1150px]   w-full mx-auto bg-blue-600 overflow-hidden relative  rounded flex flex-wrap items-center ">
